...
class App(ctk.CTk):
    ...
    def remove(self):
        ...
        if remove_window.address and remove_window.user:
            ...
            RemovePassword().remove_password(remove_window.address, remove_window.user)
            self.reload_table()
    ...
    def simplePassword(self):
        ...
        if app.password:
            ...
            # Frame for contain label and buttons
    ...
    def complexPassword(self):
        ...
        if app.password:
            ...
            # Frame for contain label and button
            self.areaPrintPassword = ctk.CTkFrame(self.areaGenerate)
            self.areaPrintPassword.grid(row=0, rowspan=2, column=1, padx=padMain, pady=padMain)
    ...
    def save_password(self, password):
        """Open window for save generated password"""
